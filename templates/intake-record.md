...
_Created {{DATE}} · slug `{{SLUG}}` · {{EMAIL}} · this is Claude's persistent memory of {{FIRST_NAME}}. Read at every session start; append durable facts as we work._
...
- **Active deals / projects:** {{ACTIVE_DEALS}}
- **Key people / contacts:** {{CONTACTS}}
